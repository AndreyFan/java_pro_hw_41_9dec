...
class UsersControllerTest {
    ...
    void getAllUsers() throws Exception {
        when(usersServiceMock.getAllUsers()).thenReturn(List.of(new UserDto(1, test_name, test_email, "55555", "password", UserDto.Role.CLIENT)));
    ...
    void getUserByID() throws Exception {
        Long testId = 1L;
        when(usersServiceMock.getUserByID(testId)).thenReturn(new UserDto(testId, test_name, test_email, "55555", "password", UserDto.Role.CLIENT));
    ...
    void getUserByName() throws Exception {
        when(usersServiceMock.getUserByName(test_name)).thenReturn(new UserDto(1L, test_name, test_email, "55555", "password", UserDto.Role.CLIENT));
